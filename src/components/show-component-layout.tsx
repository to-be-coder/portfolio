        ...
        <div className="container mx-auto  pb-8">
          ...
          <Tabs defaultValue="preview">
            <TabsList className="flex gap-4 justify-start border-b border-[#c0c0c0] mb-8 mt-2">
              <TabsTrigger
                value="preview"
                className="text-xl border-0 px-4 pb-0 pt-2 font-medium data-[state=active]:border-b-2 data-[state=active]:border-[#FFA813] data-[state=active]:text-[#FFA813] data-[state=inactive]:text-gray-500 hover:text-gray-900 shadow-none"
              >
                Preview
              </TabsTrigger>
              <TabsTrigger
