...
export const portfolioItems: PortfolioItemType[] = [
  ...
  { id: 1, name: 'Meta', href: '/works/meta', bgColor: '#FF66D4', image: '/meta.png', tags: ['AI', 'Project Leader'] },
  { id: 2, name: 'Teachable', href: '/works/teachable', bgColor: '#FFAD56', image: '/teachable.svg', tags: ['AI', 'Project Leader'] },
  { id: 3, name: 'Compost Now', href: '/works/compostnow', bgColor: '#3E98FE', image: '/compostnow.png', tags: ['AI', 'Project Leader'] },
  { id: 4, name: 'Spiritune', href: '/works/spiritune', bgColor: '#36CDFF', image: '/spiritune-black.svg', tags: ['AI', 'Project Leader'] },
  { id: 5, name: 'Fractional', href: '/works/fractional', bgColor: '#FFFC3B', image: '/fractional.svg', tags: ['AI', 'Project Leader'] },
