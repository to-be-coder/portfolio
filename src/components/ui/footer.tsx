      ...
      <div className="container max-w-7xl mx-auto px-8 py-4">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex gap-6 flex-1 items-center">
            ...
            <Link href="https://www.linkedin.com/in/design-jessicacheng" className="text-white hover:text-secondary flex items-center gap-1" target="_blank" rel="noopener noreferrer">
              LinkedIn
