...
const inputVariants = cva(
  'file:text-foreground placeholder:text-muted-foreground flex h-9 w-full min-w-0 text-base file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
  {
    variants: {
      variant: {
        default:
