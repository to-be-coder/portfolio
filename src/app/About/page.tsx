    ...
    <div className="mx-auto max-w-7xl px-6 h-[calc(100vh-5rem)] flex items-center lg:px-8">
      <div className="flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="w-full md:w-1/2 space-y-4">
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Jessica Cheng</h1>
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-3">
              ...
              <AccordionContent className="px-4 pb-2 pt-0 text-sm text-gray-600">
                Camping, photography, travel, anime, food, and more! P.S. I am still deciding on whether I like dipping my cookie in coffee.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
