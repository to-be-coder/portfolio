    ...
    <main>
      ...
      <ProjectSection>
        <VerticalBlock title="Overview" titleColor="text-[#a1a1a1]" borderColor="border-[#C1C1C1]">
          ...
          <p>
            <br /> I led UX strategy and prototyping, working closely with engineering to align on feasibility and surface design risks early. This work helped Mozilla align cross-functionally and
            laid the foundation for deeper testing and iteration.
          </p>
        </VerticalBlock>
      ...
      <ProjectSection bgClassName="bg-primary" textClassName="text-white">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <Link
              href="https://www.figma.com/design/q77RkGzo90PYeOzwp1ADJm/Jess-s-Portfolio?node-id=3-13787&p=f&t=yh9sFX55LJAbge6Z-0"
